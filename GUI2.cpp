#include<windows.h>
using namespace std;
HWND hButton; //The hButton Handler
LRESULT CALLBACK WndProc(HWND hWnd, UINT Msg, WPARAM wParam, LPARAM lParam)
{
	...
	{
		//This Is Our Create
    case WM_CREATE://This Is NOW HOW YOU ADD THINGS TO YOUR WINDOW 
      hButton=CreateWindow(TEXT("Btn"),TEXT("RUN"),WS_VISIBLE|WS_CHILD|BS_FLAT,0 /*x Pos*/,0 /*Y POS*/,100,100/*Width And Height*/,hWnd,NULL,NULL,NULL);
      break;
      //Create
		case WM_CLOSE:
